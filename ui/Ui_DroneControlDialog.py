...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayout_7.addWidget(self.up_btn)
        ...
        self.verticalLayout_7.addWidget(self.down_btn)
        ...
        self.verticalLayout_7.addWidget(self.takeoff_button)
        ...
        self.horizontalLayout_11.addWidget(self.start_analysis_btn)
        self.stop_analysis_btn = QtWidgets.QPushButton(self.widget)
        self.stop_analysis_btn.setObjectName("stop_analysis_btn")
        self.horizontalLayout_11.addWidget(self.stop_analysis_btn)
        self.verticalLayout_2.addLayout(self.horizontalLayout_11)
        self.livestream_btn = QtWidgets.QPushButton(self.widget)
        self.livestream_btn.setObjectName("livestream_btn")
        self.verticalLayout_2.addWidget(self.livestream_btn)
        ...
        self.live_stream_widget = QtWidgets.QWidget(self.layoutWidget)
        self.live_stream_widget.setMinimumSize(QtCore.QSize(300, 150))
        self.live_stream_widget.setObjectName("live_stream_widget")
        self.verticalLayout_6.addWidget(self.live_stream_widget)
        ...
        self.label_clear_messages = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.clear_msg_button = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 162, 209))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.start_analysis_btn.setText(_translate("Dialog", "Start measurment"))
        self.stop_analysis_btn.setText(_translate("Dialog", "Stop measurment"))
        self.livestream_btn.setText(_translate("Dialog", "livestream"))
