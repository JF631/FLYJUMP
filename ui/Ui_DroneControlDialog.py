...
# Form implementation generated from reading ui file '.\ui\DroneControlDialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.up_btn = QtWidgets.QPushButton(self.layoutWidget)
        self.up_btn.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\ui\\icons/arrow_up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(".\\ui\\icons/arrow_left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(".\\ui\\icons/arrow_right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.down_btn = QtWidgets.QPushButton(self.layoutWidget)
        self.down_btn.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(".\\ui\\icons/arrow_down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.live_stream_widget = QtWidgets.QWidget(self.layoutWidget1)
        ...
        self.label_clear_messages = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.clear_msg_button = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.scrollArea = QtWidgets.QScrollArea(self.layoutWidget2)
        self.scrollArea.setMinimumSize(QtCore.QSize(100, 50))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 127, 65))
