...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_clear_messages = QtWidgets.QLabel(self.widget1)
        ...
        self.clear_msg_button = QtWidgets.QPushButton(self.widget1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 124, 70))
